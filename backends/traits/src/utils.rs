...
/// strip this prefix from all received [`Sample::res_name`](janu::net::Sample::res_name) to retrieve the corrsponding key.
///
/// # Examples:
/// ```
/// # use janu_backend_traits::utils::get_keys_prefix;
...
/// the given Path Expr.
///
/// Use this operation in [`Storage::on_query()`](crate::Storage::on_query()) implementation to transform the received [`Query::res_name`](janu::net::Query::res_name) in a list of path
...
/// # Examples:
/// ```
/// # use janu_backend_traits::utils::get_sub_path_exprs;
/// assert_eq!(
///     ["**"],
