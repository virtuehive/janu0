...
//! This crate provides the traits to be implemented by a janu backend library:
//!  - [`Backend`]
//!  - [`Storage`]
//!
...
//! use janu::net::Sample;
//! use janu::{utils, ChangeKind, Properties, Value, ZResult};
...
//!                     Some(ts) => ts.clone(),
//!                     None => janu::utils::new_reception_timestamp(),
//!                 },
//!             )
//!         } else {
//!             (ChangeKind::Put, janu::utils::new_reception_timestamp())
//!         };
...
use janu::net::Sample;
use janu::{Properties, Selector, Value, ZError, ZResult};
...
/// A wrapper around the [`janu::net::Query`] allowing to call the
