...
//! # The plugin infrastructure for Janu.
//!
...
/// Janu plugins must implement [`Plugin<Requirements=Vec<clap::Arg<'static, 'static>>, StartArgs=(janu::net::runtime::Runtime, clap::ArgMatches)>`](Plugin)
pub trait Plugin: Sized + 'static {
    ...
    /// As Janu instanciates plugins, it will append their [`Compatibility`] to an array.
