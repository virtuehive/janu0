...
use janu::net::protocol::core::{Channel, CongestionControl, PeerId, ResKey};
use janu::net::protocol::io::ZBuf;
use janu::net::protocol::proto::{DataInfo, JanuMessage};

fn consume_message(msg: JanuMessage) {
    drop(msg);
}

fn consume_message_arc(msg: Arc<JanuMessage>) {
    drop(msg);
}
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let msg = Arc::new(JanuMessage::make_data(
        res_key,
        payload,
        channel,
        congestion_control,
