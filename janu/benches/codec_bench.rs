...
use janu::net::protocol::core::{Channel, CongestionControl, Priority, Reliability, ResKey, ZInt};
use janu::net::protocol::io::{WBuf, ZBuf, ZSlice};
use janu::net::protocol::proto::{
    Attachment, Frame, FramePayload, TransportMessage, JanuMessage,
};
...
fn bench_write_data(buf: &mut WBuf, data: &mut JanuMessage) {
    buf.write_janu_message(data);
}
