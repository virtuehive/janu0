...
/// A janu Selector is the conjunction of a [path expression](super::PathExpr) identifying a set
...
///
/// _**NOTE**_: _the filters and fragments are not yet supported in current janu version._
pub struct Selector {
    /// the path expression part of this Selector (before `?` character).
    pub path_expr: PathExpr,
    /// the predicate part of this Selector, as used in janu-net.
