...
use super::protocol::proto::{JanuBody, JanuMessage};
use super::routing;
...
impl TransportPeerEventHandler for RuntimeSession {
    fn handle_message(&self, mut msg: JanuMessage) -> ZResult<()> {
        // critical path shortcut
        if let JanuBody::Data(data) = msg.body {
