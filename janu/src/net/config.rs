...
pub use janu_util::properties::config::*;

/// A set of Key/Value (`u64`/`String`) pairs to pass to [open](super::open)  
/// to configure the janu-net [Session](super::super::Session).
///
/// Multiple values are coma separated.
///
/// The [IntKeyProperties](janu_util::properties::IntKeyProperties) can be built from (`String`/`String`)
/// [Properties](super::super::Properties) and reverse.

/// Creates an empty janu net Session configuration.
pub fn empty() -> ConfigProperties {
    ConfigProperties::default()
}

/// Creates a default janu net Session configuration.
///
...
/// Creates a default `'peer'` mode janu net Session configuration.
///
/// The returned configuration contains :
///  - `(ZN_MODE_KEY, "peer")`
...
/// Creates a default `'client'` mode janu net Session configuration.
///
/// The returned configuration contains :
///  - `(ZN_MODE_KEY, "client")`
///
