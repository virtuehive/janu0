...
/// Sequence Number
///
/// Janu sequence numbers have a negotiable resolution. Each session can
...
impl SeqNum {
    ...
    ///                  As a consequence of wire janu's representation of sequence numbers it is
...
impl SeqNumGenerator {
    ...
    ///                  As a consequence of wire janu's representation of sequence numbers
